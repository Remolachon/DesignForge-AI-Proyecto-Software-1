...
const LightRays = ({
  ...
  const activeColor = mounted && (lightColor || darkColor) 
    ? (activeTheme === 'dark' ? (darkColor || raysColor) : (lightColor || raysColor)) 
    : raysColor;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  fragColor = vec4(finalColor * totalStrength, totalStrength);
}
