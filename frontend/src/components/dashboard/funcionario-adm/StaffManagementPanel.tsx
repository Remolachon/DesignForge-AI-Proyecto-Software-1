...
import { StaffManagementLoading } from './StaffManagementLoading';
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border bg-muted/40">
                      ...
                      <th className="px-5 py-3 text-left font-medium text-muted-foreground">Asignado el</th>
                      <th className="px-5 py-3 text-left font-medium text-muted-foreground">Estado</th>
                      <th className="px-5 py-3 text-right font-medium text-muted-foreground">Acción</th>
                    </tr>
                  </thead>
          ...
          <AlertDialog open={!!memberToRemove} onOpenChange={(open) => !open && setMemberToRemove(null)}>
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                >
                  {removeLoading ? <RefreshCw className="mr-2 h-4 w-4 animate-spin" /> : null}
                  Quitar funcionario
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
