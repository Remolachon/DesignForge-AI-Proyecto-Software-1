...
import { Plus, Package, Clock, TrendingUp, ShoppingBag } from 'lucide-react';
...
export default function ClienteDashboard() {
  ...
  const activeOrders = mockPedidos.filter(
    (p) => p.status === 'En diseño' || p.status === 'En producción',
  ).length;

  const pendingDelivery = mockPedidos.filter(
    (p) => p.status === 'Listo para entrega',
  ).length;
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <QuickActionCard
              ...
              title="Marketplace"
              description="Explora productos listos para comprar"
            />
            <QuickActionCard
              ...
              iconBg="bg-primary/10"
              title="Mis Pedidos"
              description="Ver historial y seguimiento de pedidos"
            />
          </div>
        </section>
