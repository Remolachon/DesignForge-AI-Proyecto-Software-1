// app/login/page.tsx (si usas App Router en Next.js 13+)
// o pages/login.tsx (si usas Pages Router en Next.js <=12)

"use client"; // necesario si usas App Router y hooks de estado
